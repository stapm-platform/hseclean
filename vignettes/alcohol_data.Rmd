---
title: "Process data on alcohol consumption"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Process data on alcohol consumption}
...
```{r drinkyn, eval = F, fig.width = 7, fig.height = 4}
...
```{r drinkfreq, eval = F, fig.width = 7, fig.height = 6}
...
```{r alc_12month, eval = F, fig.width = 7, fig.height = 6}
...
```{r alc_12month_cat, eval = F, fig.width = 7, fig.height = 4}
...
```{r alc_7day_adult, eval = F, fig.width = 7, fig.height = 6}
...
```{r alc_adult_binge_cat, eval = F, fig.width = 7, fig.height = 4}
...
```{r alc_drinks_now_plus_kids, eval = F, fig.width = 7, fig.height = 6}
...
```{r alc_weekly_consumption_allages, eval = F, fig.width = 7, fig.height = 6}
