...
To adjust for the under-reporting of alcohol consumption in survey data, the average weekly consumption of alcohol provided by the SHeS data can be upshifted to a proportion of a reference value for alcohol consumption. For Scotland, between the years 2008 and 2019, the reference data used is the per capita sales of alcohol from the Monitoring and Evaluating Scotland's Alcohol Strategy (MESAS) monitoring report 2022. The default proportion used is 80\% (as per WHO assumptions).   
