...
The `hseclean` package contains a range of functions to clean covariates in the data, which are explained more thoroughly in `vignette("covariate_data")`. Here we describe the important things to consider for the processing of smoking data.  
