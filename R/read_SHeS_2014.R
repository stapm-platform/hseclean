...
#' Read Scottish Health Survey 2014
#'
...
#' \dontrun{
#'
#' data_2014 <- read_SHeS_2014("X:/", "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2014/UKDA-7851-tab/tab/shes14i_archive.tab")
#'
#' }
#'
read_SHeS_2014 <- function(
  root = c("X:/", "/Volumes/Shared/"),
  file = "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2014/UKDA-7851-tab/tab/shes14i_archive.tab"
) {
  ...
  other_vars <- Hmisc::Cs(
    ...
    int14wt, # individual weight after calibration
    cint14wt, # Child weight after calibration
  ...
  setnames(data,
           ...
           c("simd5_rpa", "strata", "ethnic05", "eqv5", "eqvinc",
             "cigregs",
             "w250gl7", "w175gl7", "w125gl7", "w125bl7",
             "popscl7", "popsbl7", "poplbl7",
