...
read_hse <- function(
  ...
  if (year == 2018) data <- hseclean::read_2018(root = root[1])
  if (year == 2019) data <- hseclean::read_2019(root = root[1])
  if (year == 2021) data <- hseclean::read_2021(root = root[1])
  if (year == 2022) data <- hseclean::read_2022(root = root[1])
