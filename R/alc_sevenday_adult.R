...
alc_sevenday_adult <- function(
  ...
  if(!(country == "Wales" & year > 2019)){
    ...
    if (country == "England" & year >= 2019){
      ...
      data[ , d7vol_sherry := 0]
      data[d7typ4 == 1, d7vol_sherry := shergs7 * alc_volume_data[beverage == "sherryvol", volume]]
    ...
    if (country == "England" & year >= 2019){
      ...
      data[d7typ3 == 1, d7vol_spirits := spirme7 * alc_volume_data[beverage == "spiritsvol", volume]]
