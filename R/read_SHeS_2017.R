...
#' Read Scottish Health Survey 2017
#'
...
#' living in private households in Scotland every year. In 2017, across all sample types, interviews 
#' were held in 3,062 households with 3,697 adults (aged 16 and over), and 1,603 children (aged 0-15). 
#'
#'
#' MISSING VALUES
#'
...
#' \dontrun{
#'
#' data_2017 <- read_SHeS_2017("X:/", "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2017/UKDA-8398-tab/tab/shes_17i_archive_v1.tab")
#'
#' }
#'
read_SHeS_2017 <- function(
  ...
  other_vars <- Hmisc::Cs(
    ...
    int17wt, # individual weight after calibration
    cint17wt, # Child weight after calibration
