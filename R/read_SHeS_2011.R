...
#' Read Scottish Health Survey 2011
#'
...
#' \dontrun{
#'
#' data_2011 <- read_SHeS_2011("X:/", "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2011/UKDA-7247-tab/tab/shes11i_v5.tab")
#'
#' }
#'
read_SHeS_2011 <- function(
  ...
  other_vars <- Hmisc::Cs(
    ...
    int11wt, # individual weight after calibration
    cint11wt, # Child weight after calibration
