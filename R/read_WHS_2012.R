#' Read the Welsh Health Survey 2012 \lifecycle{maturing}
#'
#' Reads and does basic cleaning on the Welsh Health Survey 2012.
#'
...
#'
#' }
read_WHS_2012 <- function(
    root = c("X:/", "/Volumes/Shared/")[1],
    file = "HAR_PR/PR/Consumption_TA/HSE/Welsh Health Survey (WHS)/2012/UKDA-7459-tab/tab/welsh_health_12_adult_archiving.tab"
) {
  ...
  # Set PSU and cluster
  #data[ , psu := paste0("2012_", 1)]
  #data[ , cluster := paste0("2012_", 1)]
