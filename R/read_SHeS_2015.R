...
#' \dontrun{
#'
#' data_2015 <- read_SHeS_2015("X:/", "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2015/UKDA-8100-tab/tab/shes15i_archive_v1.tab")
#'
#' }
#'
read_SHeS_2015 <- function(
  root = c("X:/", "/Volumes/Shared/"),
  file = "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2015/UKDA-8100-tab/tab/shes15i_archive_v1.tab"
) {
