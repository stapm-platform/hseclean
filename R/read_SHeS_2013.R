...
#' Read Scottish Health Survey 2013
#'
...
#' \dontrun{
#'
#' data_2013 <- read_SHeS_2013("X:/", "ScHARR/PR_Tobacco_mup/Data/Scottish Health Survey/SHeS 2013/UKDA-7594-tab/tab/shes13i_archive_v5.tab")
#'
#' }
#'
read_SHeS_2013 <- function(
  ...
  other_vars <- Hmisc::Cs(
    ...
    int13wt, # individual weight after calibration
    cint13wt, # Child weight after calibration
