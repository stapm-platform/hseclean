...
#' Read the Health Survey for England 2013
#'
#' Reads and does basic cleaning on the Health Survey for England 2013.
#'
#' @section Survey details:
#' The HSE 2013 included a general population sample of adults and children,
#' representative of the whole population at both national and regional level.
#' For the sample, 9,408 addresses were randomly selected in 588 postcode sectors,
#' issued over twelve months from January to December 2013. Where an address was found
#' to have multiple dwelling units, one dwelling unit was selected at random and where
#' there were multiple households at a dwelling unit, one household was selected at random.
#' In each selected household, all individuals were eligible for inclusion in the survey.
#' Where there were three or more children aged 0-15 in a household, two of the children were selected at random.
#' A nurse visit was arranged for all participants who consented.
#' A total of 8,795 adults aged 16 and over and 2,185 children aged 0-15 were interviewed.
#' A household response rate of 64% was achieved. Of those where a full
#' interview was achieved, 6,183 adults and 1,455 children also had a nurse visit.
...
#' were collected from adults aged 16 and over. Saliva samples for cotinine analysis were collected from
#' all participants aged 4 and over. Nurses obtained written consent before taking samples from adults,
#' and parents gave written consent for their children’s samples. Consent was also obtained from adults to
#' send results to their GPs, and from parents to send their children’s results to their GPs.
#'
#' @section Weighting:
#'
...
read_2013 <- function(
    ...
    file = "HAR_PR/PR/Consumption_TA/HSE/Health Survey for England (HSE)/HSE 2013/UKDA-7649-tab/tab/hse2013ai.tab",
  ...
  data.table::setnames(data,
                       c("longend2", "marstatd", "origin", "pserial", "hrollwk", "hrollwe", paste0("complst", 1:15)),
                       c("longend", "marstat", "ethnicity_raw", "hse_id", "rollwk", "rollwe", paste0("compm", 1:15)))
