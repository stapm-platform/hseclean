#' Read the Welsh Health Survey 2011 \lifecycle{maturing}
#'
#' Reads and does basic cleaning on the Welsh Health Survey 2011.
#'
...
#'
#' }
read_WHS_2011 <- function(
    root = c("X:/", "/Volumes/Shared/")[1],
    file = "HAR_PR/PR/Consumption_TA/HSE/Welsh Health Survey (WHS)/2011/UKDA-7188-tab/tab/welsh_health_11_adult_archiving.tab"
    ) {
...
#
    ...
    # Set PSU and cluster
    #data[ , psu := paste0("2011_", 1)]
    #data[ , cluster := paste0("2011_", 1)]
