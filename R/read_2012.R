...
#' \dontrun{
#'
#' data_2012 <- read_2012("X:/", "ScHARR/PR_Consumption_TA/HSE/HSE 2012/UKDA-7480-tab/tab/hse2012ai.tab")
#'
#' }
#'
read_2012 <- function(
  ...
  setnames(data, c("marstatc", "origin", paste0("complst", 1:14)), c("marstat", "ethnicity_raw", paste0("compm", 1:14)))
