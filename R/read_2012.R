...
#' Read the Health Survey for England 2012
#'
...
read_2012 <- function(
  ...
  data.table::setnames(data,
                       c("marstatc", "smkdad", "smkmum", "origin", "pserial", paste0("complst", 1:15)),
                       c("marstat", "fathsm", "mothsm", "ethnicity_raw", "hse_id", paste0("compm", 1:15)))
