#' Read the Welsh Health Survey 2014 \lifecycle{maturing}
#'
#' Reads and does basic cleaning on the Welsh Health Survey 2014.
#'
...
#'
#' }
read_WHS_2014 <- function(
    root = c("X:/", "/Volumes/Shared/")[1],
    file = "HAR_PR/PR/Consumption_TA/HSE/Welsh Health Survey (WHS)/2014/UKDA-7841-tab/tab/whs_2014_adult_archive.tab"
    ) {
...
#
    ...
    # Set PSU and cluster
    data[ , psu := paste0("2014_", 1)]
    data[ , cluster := paste0("2014_", 1)]
