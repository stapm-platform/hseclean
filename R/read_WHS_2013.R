...
#'
#' }
read_WHS_2013 <- function(
    root = c("X:/", "/Volumes/Shared/")[1],
    file = "HAR_PR/PR/Consumption_TA/HSE/Welsh Health Survey (WHS)/2013/UKDA-7632-tab/tab/welsh_health_13_adult_archiving.tab"
    ) {
...
#
    ...
    # Set PSU and cluster
    data[ , psu := paste0("2013_", 1)]
    data[ , cluster := paste0("2013_", 1)]
