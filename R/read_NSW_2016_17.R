...
read_NSW_2016_17 <- function(
    ...
    file = "HAR_PR/PR/Consumption_TA/HSE/National Survey for Wales (NSW)/NSW 2016/UKDA-8301-tab/tab/national_survey_for_wales_2016-17_respondent_data_anonymised_ukds.tab"
    ) {
