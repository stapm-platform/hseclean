...
# hseclean <img src="logo.png" align="right" style="padding-left:10px;background-color:white;" width="100" height="100" />
...
**Note that you might not have to clean the data yourself as we can
provide you with datasets for running the models that have already been
cleaned.**
