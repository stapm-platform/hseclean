...
The package is usable but there are still a number of bugs and further developments that we are working through i.e. some code and documentation is still incomplete or in need of being refined. The code and documentation are still undergoing internal review by The University of Sheffield team.   
...
There are separate functions to process each socioeconomic variables. See `vignette("covariate_data")`.     
