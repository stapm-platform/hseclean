...
2. Go to the Terminal window in R Studio (or a console window in Windows by searching for "cmd") and install the package from the downloaded file by typing `R CMD INSTALL Downloads/dosgillespie-hseclean-0.3.3-0-ga16f575.tar.gz`.  
...
At The University of Sheffield, the data is stored in the university networked X-drive folder `PR_Consumption_TA`, which is accessible only to team members who are using data according to the purposes stated to the UK Data Service.   

No individual-level Health Survey for England or Scottish Health Survey data is included within this package on Github.   
