...
include_graphics("25_plots/01_drink_amount.png")
```
...
include_graphics("25_plots/01_drink_amount_imd.png")
```
...
include_graphics("25_plots/01_drink_amount_sex.png")
```
...
include_graphics("25_plots/01_drink_amount_shes_vs_hseclean.png")
```
...
include_graphics("25_plots/02_drink_prop_imd.png")
```
...
include_graphics("25_plots/03_weekdrnk.png")
```
...
include_graphics("25_plots/03_weekdrnk_sex.png")
```
...
include_graphics("25_plots/03_weekdrnk_imd.png")
```
...
include_graphics("25_plots/04_agetrend_prop.png")
```
...
include_graphics("25_plots/04_agetrend_prop_sex.png")
```
...
include_graphics("25_plots/04_agetrend_prop_imd.png")
```
...
include_graphics("25_plots/05_agetrend_mean.png")
```
...
include_graphics("25_plots/05_agetrend_mean_sex.png")
```
...
include_graphics("25_plots/05_agetrend_mean_imd.png")
```
...
include_graphics("25_plots/06_drink_prefs.png")
```
...
include_graphics("25_plots/06_drink_prefs_sex.png")
```
...
include_graphics("25_plots/06_drink_prefs_imd.png")
```
...
include_graphics("25_plots/07_drink_prefs_trend.png")
```
...
include_graphics("25_plots/08_drink_prefs_agetrend.png")
```
...
- Github code repository https://github.com/STAPM/hseclean
